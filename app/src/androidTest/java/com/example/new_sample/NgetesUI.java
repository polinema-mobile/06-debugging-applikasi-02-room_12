...
public class NgetesUI {
    ...
    public void tesKlikBagi(){
        ...
        onView(withId(R.id.output)).check(matches(withText("484")));
    }
    ...
    public void tesKlikKali(){
        ...
        onView(withId(R.id.button3)).perform(click());
        onView(withId(R.id.button_equal)).perform(click());
        onView(withId(R.id.output)).check(matches(withText("711")));
    }
    ...
    public void tesKlikKurang(){
        ...
        onView(withId(R.id.button1)).perform(click());
        onView(withId(R.id.button_equal)).perform(click());
        onView(withId(R.id.output)).check(matches(withText("3253")));
    }
    ...
    public void tesKlikTambah(){
        ...
        onView(withId(R.id.button_equal)).perform(click());
        onView(withId(R.id.output)).check(matches(withText("80235")));
    }
    ...
    public void tesKlikPoint(){
        ...
        onView(withId(R.id.button2)).perform(click());
        onView(withId(R.id.button_equal)).perform(click());
        onView(withId(R.id.output)).check(matches(withText("16.4")));
    }
